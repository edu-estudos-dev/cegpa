  ...
  `;
        ...
        try {
            ...
            const quantidadeNoEstoque =
                resultEstoque[0].quantidadeNoEstoque || 0;
    ...
    `;
        ...
        try {
            ...
            console.log(
                'Resultados da query getItensNaoPagosPorCategoria:',
                results
            ); // Logar resultados da query
    ...
    `;
        ...
        try {
            ...
            console.log(
                'Resultados da query getItensNaoPagosPorSubgrupo:',
                results
            ); // Logar resultados da query

            if (results.length === 0) {
                console.error(
                    'Nenhum resultado encontrado para o subgrupo:',
                    subgrupo
                );
                return 0;
            }
    ...
    `;
        ...
        try {
            const [resultsEstoque] = await connection.execute(queryEstoque, [
                tombo,
            ]);
            ...
            const [resultsSaida] = await connection.execute(querySaida, [
                idEstoque,
            ]);
            ...
            console.error(
                'Erro ao buscar informações de saída do tombo:',
                error
            );
            throw error;
        }
